...
**Reranker:** `cohere` · **low-confidence action:** `decline` · **cache reuse:** `True`
...
|---|---:|---:|---:|---:|---:|---:|---:|
| A (Lab vs PS) | 5 | 80%→0% (-80%) | 0% | 0% | 0% | 4383 | 0 |
| B (Roman numeral siblings, cross-doc) | 2 | 100%→0% (-100%) | 0% | 0% | 0% | 6220 | 0 |
| C (lookalike-unrelated) | 2 | 100%→0% (-100%) | 0% | 0% | 0% | 2768 | 0 |
| E (cache anchoring) | 0 | — | — | — | — | — | — |
| F1 (explicit conceptual switch) | 2 | 50%→0% (-50%) | 0% | 0% | 0% | 3776 | 0 |
| F2 (explicit document switch) | 3 | 67%→0% (-67%) | 0% | 0% | 0% | 4284 | 0 |
| working cases | 1 | 100%→0% (-100%) | 0% | 0% | 0% | 2463 | 0 |
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|
| H (multi-document intent) | 8 | 0% | 0% | 0% | — | — | 0.0 | 4001 |
| I (document correction) | 4 | 0% | 0% | — | — | — | 0.0 | 3370 |
| K (followup/clarification) | 1 | 100% | 0% | — | 100% | — | 0.0 | 5274 |
| L (off-topic / redirect) | 16 | 12% | 0% | — | 12% | 12% | 0.0 | 3327 |
| M (coverage gap / acknowledge) | 17 | 100% | 0% | — | 13% | — | 2.4 | 3194 |
