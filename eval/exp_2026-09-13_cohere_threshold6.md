...
**Total rows:** 61 (61 in-corpus + 0 not-in-corpus). **Errors:** 0.
**Reranker:** `cohere` · **low-confidence action:** `collapse` · **cache reuse:** `True`
...
|---|---:|---:|---:|---:|---:|---:|---:|
| A (Lab vs PS) | 5 | 80%→100% (+20%) | 60% | 0% | 0% | 4045 | 0 |
| B (Roman numeral siblings, cross-doc) | 2 | 100%→100% (+0%) | 100% | 0% | 0% | 6109 | 0 |
| C (lookalike-unrelated) | 2 | 100%→100% (+0%) | 0% | 0% | 0% | 2710 | 0 |
| E (cache anchoring) | 0 | — | — | — | — | — | — |
| F1 (explicit conceptual switch) | 2 | 50%→50% (+0%) | 50% | 50% | 0% | 2783 | 0 |
| F2 (explicit document switch) | 3 | 67%→67% (+0%) | 100% | 0% | 0% | 3741 | 0 |
| working cases | 1 | 100%→100% (+0%) | 100% | 0% | 0% | 3036 | 0 |
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|
| H (multi-document intent) | 8 | 25% | 88% | 25% | — | — | 4.1 | 3477 |
| I (document correction) | 4 | 25% | 25% | — | — | — | 6.5 | 4274 |
| K (followup/clarification) | 1 | 100% | 0% | — | 100% | — | 8.0 | 7464 |
| L (off-topic / redirect) | 16 | 12% | 0% | — | 12% | 12% | 2.9 | 3416 |
| M (coverage gap / acknowledge) | 17 | 59% | 0% | — | 13% | — | 5.1 | 3518 |
