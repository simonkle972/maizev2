...
**Reranker:** `cohere` · **low-confidence action:** `widen` · **cache reuse:** `True`
...
|---|---:|---:|---:|---:|---:|---:|---:|
| A (Lab vs PS) | 5 | 80%→100% (+20%) | 0% | 0% | 0% | 8267 | 0 |
| B (Roman numeral siblings, cross-doc) | 2 | 100%→100% (+0%) | 0% | 50% | 0% | 12971 | 0 |
| C (lookalike-unrelated) | 2 | 100%→100% (+0%) | 0% | 0% | 0% | 6852 | 0 |
| E (cache anchoring) | 0 | — | — | — | — | — | — |
| F1 (explicit conceptual switch) | 2 | 50%→100% (+50%) | 0% | 0% | 0% | 6500 | 0 |
| F2 (explicit document switch) | 3 | 67%→100% (+33%) | 0% | 0% | 0% | 6671 | 0 |
| working cases | 1 | 100%→100% (+0%) | 0% | 0% | 0% | 5235 | 0 |
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|
| H (multi-document intent) | 8 | 50% | 88% | 50% | — | — | 8.0 | 6715 |
| I (document correction) | 4 | 75% | 75% | — | — | — | 7.2 | 5830 |
| K (followup/clarification) | 1 | 100% | 0% | — | 100% | — | 1.0 | 2253 |
| L (off-topic / redirect) | 16 | 12% | 0% | — | 12% | 12% | 7.0 | 5012 |
| M (coverage gap / acknowledge) | 17 | 100% | 0% | — | 13% | — | 8.0 | 4207 |
