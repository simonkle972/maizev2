...
**Total rows:** 57 (57 in-corpus + 0 not-in-corpus). **Errors:** 0.
...
|---|---:|---:|---:|---:|---:|---:|---:|
| A (Lab vs PS) | 0 | — | — | — | — | — | — |
| B (Roman numeral siblings, cross-doc) | 7 | 86%→71% (-14%) | 14% | 0% | 0% | 16028 | 0 |
| C (lookalike-unrelated) | 2 | 50%→100% (+50%) | 50% | 0% | 0% | 12143 | 0 |
| E (cache anchoring) | 16 | 88%→75% (-12%) | 56% | 19% | 12% | 31329 | 0 |
| F1 (explicit conceptual switch) | 3 | 100%→100% (+0%) | 0% | 0% | 0% | 13113 | 0 |
| F2 (explicit document switch) | 2 | 100%→100% (+0%) | 50% | 0% | 0% | 7450 | 0 |
| working cases | 19 | 68%→68% (+0%) | 32% | 0% | 0% | 15494 | 0 |
