...
**Reranker:** `cohere` · **low-confidence action:** `widen` · **cache reuse:** `True` · **rerank query:** `concat`
...
|---|---:|---:|---:|---:|---:|---:|---:|
| A (Lab vs PS) | 5 | 80%→100% (+20%) | 0% | 0% | 0% | 8915 | 0 |
| B (Roman numeral siblings, cross-doc) | 2 | 100%→100% (+0%) | 0% | 50% | 0% | 12756 | 0 |
| C (lookalike-unrelated) | 3 | 67%→67% (+0%) | 0% | 0% | 0% | 4249 | 0 |
| E (cache anchoring) | 0 | — | — | — | — | — | — |
| F1 (explicit conceptual switch) | 2 | 50%→50% (+0%) | 0% | 50% | 0% | 3868 | 0 |
| F2 (explicit document switch) | 23 | 35%→61% (+26%) | 61% | 0% | 0% | 4740 | 0 |
| working cases | 5 | 80%→100% (+20%) | 0% | 0% | 0% | 5580 | 0 |
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|
| H (multi-document intent) | 8 | 50% | 88% | 50% | — | — | 8.5 | 5426 |
| I (document correction) | 4 | 75% | 75% | — | — | — | 9.8 | 6140 |
| K (followup/clarification) | 1 | 100% | 0% | — | 100% | — | 1.0 | 4338 |
| L (off-topic / redirect) | 16 | 12% | 0% | — | 12% | 12% | 7.0 | 5695 |
| M (coverage gap / acknowledge) | 12 | 100% | 0% | — | 20% | — | 8.0 | 3608 |
