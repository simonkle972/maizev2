...
**Reranker:** `cohere` · **low-confidence action:** `widen` · **cache reuse:** `True` · **rerank query:** `raw`
...
|---|---:|---:|---:|---:|---:|---:|---:|
| A (Lab vs PS) | 5 | 80%→100% (+20%) | 0% | 0% | 0% | 8622 | 0 |
| B (Roman numeral siblings, cross-doc) | 2 | 100%→100% (+0%) | 0% | 50% | 0% | 12446 | 0 |
| C (lookalike-unrelated) | 3 | 67%→100% (+33%) | 0% | 0% | 0% | 8157 | 0 |
| E (cache anchoring) | 0 | — | — | — | — | — | — |
| F1 (explicit conceptual switch) | 2 | 50%→100% (+50%) | 0% | 0% | 0% | 5388 | 0 |
| F2 (explicit document switch) | 23 | 43%→70% (+26%) | 57% | 0% | 0% | 5167 | 0 |
| working cases | 5 | 80%→100% (+20%) | 0% | 0% | 0% | 6289 | 0 |
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|
| H (multi-document intent) | 8 | 50% | 88% | 50% | — | — | 8.0 | 5995 |
| I (document correction) | 4 | 75% | 75% | — | — | — | 7.2 | 7046 |
| K (followup/clarification) | 1 | 100% | 0% | — | 100% | — | 1.0 | 4609 |
| L (off-topic / redirect) | 16 | 12% | 0% | — | 12% | 12% | 7.0 | 5433 |
| M (coverage gap / acknowledge) | 12 | 100% | 0% | — | 20% | — | 8.0 | 4068 |
