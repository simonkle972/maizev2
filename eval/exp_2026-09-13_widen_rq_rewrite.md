...
**Total rows:** 81 (81 in-corpus + 0 not-in-corpus). **Errors:** 0.
**Reranker:** `cohere` · **low-confidence action:** `widen` · **cache reuse:** `True` · **rerank query:** `rewrite`
...
|---|---:|---:|---:|---:|---:|---:|---:|
| A (Lab vs PS) | 5 | 80%→100% (+20%) | 0% | 0% | 0% | 9429 | 0 |
| B (Roman numeral siblings, cross-doc) | 2 | 100%→100% (+0%) | 0% | 50% | 0% | 14366 | 0 |
| C (lookalike-unrelated) | 3 | 67%→100% (+33%) | 0% | 0% | 0% | 6246 | 0 |
| E (cache anchoring) | 0 | — | — | — | — | — | — |
| F1 (explicit conceptual switch) | 2 | 50%→50% (+0%) | 0% | 50% | 0% | 3564 | 0 |
| F2 (explicit document switch) | 23 | 35%→78% (+43%) | 61% | 0% | 0% | 4866 | 0 |
| working cases | 5 | 80%→100% (+20%) | 0% | 0% | 0% | 7120 | 0 |
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|
| H (multi-document intent) | 8 | 62% | 88% | 62% | — | — | 8.0 | 5641 |
| I (document correction) | 4 | 75% | 75% | — | — | — | 8.0 | 7259 |
| K (followup/clarification) | 1 | 100% | 0% | — | 100% | — | 1.0 | 3787 |
| L (off-topic / redirect) | 16 | 12% | 0% | — | 12% | 12% | 7.0 | 5887 |
| M (coverage gap / acknowledge) | 12 | 100% | 0% | — | 20% | — | 8.0 | 4386 |
