...
**Total rows:** 112 (109 in-corpus + 3 not-in-corpus). **Errors:** 0.
...
| Failure type | n | hit@5 pre→post (lift) | collapsed_to_full_doc | hard_neg_top1 | forbidden_hit | forbidden_text_hit | avg_latency_ms | errors |
|---|---:|---:|---:|---:|---:|---:|---:|---:|
| A (Lab vs PS) | 7 | 86%→86% (+0%) | 86% | 14% | 0% | 0% | 20303 | 0 |
| B (Roman numeral siblings, cross-doc) | 5 | 100%→80% (-20%) | 80% | 0% | 0% | 0% | 16719 | 0 |
| C (lookalike-unrelated) | 7 | 71%→57% (-14%) | 57% | 14% | 14% | 0% | 13855 | 0 |
| D (problem-vs-solutions) | 5 | 60%→60% (+0%) | 40% | 20% | 0% | 0% | 21460 | 0 |
| E (cache anchoring) | 22 | 18%→50% (+32%) | 86% | 14% | 0% | 0% | 7035 | 0 |
| F1 (explicit conceptual switch) | 0 | — | — | — | — | — | — | — |
| F2 (explicit document switch) | 1 | 0%→0% (+0%) | 100% | 100% | 0% | 0% | 1187 | 0 |
| G1 (intra-doc section confusion) | 1 | 0%→0% (+0%) | 100% | 100% | 0% | 100% | 2678 | 0 |
| G2 (intra-doc Roman/numeric sibling) | 2 | 0%→0% (+0%) | 100% | 100% | 0% | 100% | 2206 | 0 |
| working cases | 50 | 30%→60% (+30%) | 70% | 4% | 2% | 0% | 8493 | 0 |
...
| L (off-topic / redirect) | 7 | 14% | 0% | — | 14% | 14% | 1.4 | 12323 |
| M (coverage gap / acknowledge) | 2 | 0% | 0% | — | — | — | 1.0 | 15201 |
